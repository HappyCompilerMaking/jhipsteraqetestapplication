...
To build the final jar and optimize the jhipsteraqetestApplication application for production, run:
...
Then navigate to [http://localhost:8099](http://localhost:8099) in your browser.
...
[doing api-first development]: https://www.jhipster.tech/documentation-archive/v6.3.0/doing-api-first-development/
